...
**Spec version.** This document targets [`ethereum/consensus-specs`](https://github.com/ethereum/consensus-specs) at commit [`6b2201c3`](https://github.com/ethereum/consensus-specs/commit/6b2201c3c25603f24ae967a92bbce5340d672c5c), Gloas fork: [`specs/gloas/`](https://github.com/ethereum/consensus-specs/tree/6b2201c3c25603f24ae967a92bbce5340d672c5c/specs/gloas); inline `file:line` references are to that commit. The Gloas specs are work-in-progress and may differ from the EIP-7732 draft summary.
...
We've referred to "the builder's bid" loosely; we now make the object concrete. The bid is the `ExecutionPayloadBid` SSZ container, wrapped in `SignedExecutionPayloadBid` for transport. Spec source: [`beacon-chain.md`](https://github.com/ethereum/consensus-specs/blob/6b2201c3c25603f24ae967a92bbce5340d672c5c/specs/gloas/beacon-chain.md) §`ExecutionPayloadBid`. The fields:
