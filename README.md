...
| `parent_remains_canonical(B)`                                                                       | Strengthening hypothesis introduced in §4 and invoked by the §8.4 P1 and P2 proof sketches: "parent(B) remains in the canonical chain of every honest validator at every later time." Not a spec function; closes the split-vote-reorg gap left by the cautious-reveal threshold in**A6**. See §4 for the open work to weaken it.                                                                                                                                |
...
*Assumptions used:* **G-BidAdmit**, **G-Settle**, **G-PayAttest**, **G-PayEpoch**, **G-Solvency**, **`parent_remains_canonical`** (strengthening, §4 — supplies the "B canonical from slot N+2 onward" hypothesis P1 needs, which is itself a downstream consequence of P2's argument).
...
*Assumptions used:* **S1**, **S2**, **S4** (honest slot-N PTC majority + honest slot-N+1 proposer), **A1**, **A4**, **A6**, **`parent_remains_canonical`** (strengthening, §4), **G-Struct**, **G-Weight**, **G-Tiebreaker**.
...
† P1 and P2 additionally invoke the strengthening hypothesis **`parent_remains_canonical(B)`** — parent(B) remains in the canonical chain of every honest validator at every later time. This closes the split-vote-reorg gap left by the cautious-reveal threshold at 40%. Documented in §4 along with the open work to weaken it (likely by tightening A6's threshold or adding a "block timely" precondition).
